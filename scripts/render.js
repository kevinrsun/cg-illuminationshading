                ...
                models: [
                    {
                        ...
                        shader: 'texture',
                        material: {
                            color: vec3.fromValues(0.0, 0.0, 0.0),  // red, green, blue
                            specular: vec3.fromValues(0.0, 0.0, 0.0),  // red, green, blue
                            shininess: 1
                        },
                        texture: {
                            "url": "images/paulrudd.jpg",
                            "scale": [10, 10]
                        },
                ...
                light: {
                    ...
                    point_lights: [
                        ...
                        },
                        {
                            ...
                            color: vec3.fromValues(0.5, 0.5, 0.8)  // red, green, blue
                        },
                        {
                            position: vec3.fromValues(-0.8, 3.0, -2.3),  // x, y, z
                            color: vec3.fromValues(0.1, 0.5, 0.8)  // red, green, blue
                        }
                    ]
                }
            }
